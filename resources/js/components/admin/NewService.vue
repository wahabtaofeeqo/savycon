  ...
  <div>
    <div class="card">
      <div class="header">
        ...
        <p v-if="active == 0">
          <button class="btn btn-info" @click="activateService()">Activate Service</button>
        </p>
      ...
      <div class="content">
        ...
        <form
          method="POST"
          @submit.prevent="editmode ? updateService() : createService()"
        ...
        >
          <div class="row">
            <div class="col-md-7">
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <select
                      class="form-control"
                      id="category"
                      @change="loadCategoryServices()"
                      v-model="form.service.category.id"
                      required
                    >
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <select
                      class="form-control"
                      id="state"
                      @change="loadStateCities()"
                      v-model="form.city.state.id"
                      required
                    >
              ...
              <div class="form-group">
                <label for="address"
                  >Full address of where you offer this service</label
                >
                <input
                  type="text"
                  name="address"
                  ...
                  id="address"
                  placeholder="Descriptive address where you intend to offer this service"
                  class="form-control"
              ...
              <div class="form-group">
                ...
                <input
                  ...
                  id="landmark"
                  placeholder="Popular place for better description"
                  class="form-control"
                  :class="{ 'has-error': form.errors.has('landmark') }"
                  required
                />
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input
                    ...
                    placeholder="5000.00"
                    class="form-control"
                    :class="{ 'has-error': form.errors.has('price') }"
            ...
            <div class="col-md-5">
              <div class="form-group text-warning">
                <strong
                  >We strongly recommend you upload images of your services that
                  meet the following requirements:</strong
                >
                <ul>
                  ...
                  <div class="form-group">
                    ...
                    <div class="dropzone">
                      <input
                        type="file"
                        name="image_1"
                        class="form-control dropzone-file"
                        id="image_1"
                        accept="image/*"
                        @change="updateImage1"
                      />
                    ...
                    <small class="help-block text-info" v-show="!editmode"
                      ><i class="fa fa-info-circle"></i> Required</small
                    >
                    <small class="help-block text-info" v-show="editmode"
                      ><i class="fa fa-info-circle"></i> Ignore if you do not
                      wish to change</small
                    >
...
export default {
  ...
  methods: {
    ...
    loadCategoryServices() {
      ...
      axios
        .get(this.categoryServicesURL + this.form.service.category.id)
        .then((response) => {
    ...
    loadStates() {
      axios.get(this.statesURL).then((response) => {
    ...
    loadStateCities() {
      ...
      axios
        .get(this.stateCitiesURL + this.form.city.state.id)
        .then((response) => {
    ...
    activateService() {
      axios.get('/api/activateService/' + this.serviceToLoad).then((response) => {
        Swal.fire({
            icon: 'success',
            type: "success",
            title: "Service was activated successfully",
        });
