...
class ServiceListOne extends PageBuilderBase
{
    ...
    public function frontend_render()
    {
        ...
        $location_on_off = $settings["location_on_off"] ?? "yes";
        $price_range_on_off = $settings["price_range_on_off"] ?? "yes";
        $country_on_off = $settings["country_on_off"] ?? "yes";
        $city_on_off = $settings["city_on_off"] ?? "yes";
        $area_on_off = $settings["area_on_off"] ?? "yes";
        $service_search_by_text_on_off =  $settings["service_search_by_text_on_off"] ?? "";
        $category_on_off = $settings["category_on_off"] ?? "yes";
        $subcategory_on_off = $settings["subcategory_on_off"] ?? "";
        $child_category_on_off = $settings["child_category_on_off"] ?? "";
        $rating_star_on_off = $settings["rating_on_off"] ?? "yes";
        $sort_by_on_off = $settings["sort_by_on_off"] ?? "yes";
