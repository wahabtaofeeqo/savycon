...
class ServicePaymentController extends Controller
{
    ...
    public function send_order_mail($order_id)
    {
        ...
        //Send order email  and sms to buyer and seller
        try {
            ...
            Mail::to($seller_email)->queue(new OrderMail(strip_tags($mail_subject) . $order_details->id, $order_details, $message_for_seller_admin));
