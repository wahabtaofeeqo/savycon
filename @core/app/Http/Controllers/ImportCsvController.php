...
use App\Imports\ServiceCityImport;
...
//    country import
    ...
    {
        // Users
        // Excel::import(new UsersImport, public_path('dumps/users.csv'));

        // States
        // Excel::import(new ServiceCityImport, public_path('dumps/states.csv'));

        // Area
        // Excel::import(new ServiceAreaImport, public_path('dumps/cities.csv'));
