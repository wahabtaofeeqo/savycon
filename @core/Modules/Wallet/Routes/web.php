...
Route::group(['prefix' => 'admin-home/wallet','as'=>'admin.wallet.', 'middleware' => ['globalVariable','setlang']], function () {
    ...
    // jobs Settings
    Route::get( '/settings', 'Backend\WalletController@walletSettings')->name('settings');
    Route::post('/settings-update', 'Backend\WalletController@walletSettingsUpdate')->name('settings.update');
});
