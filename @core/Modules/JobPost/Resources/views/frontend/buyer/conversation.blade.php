            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-warning" id="couponModal">{{ get_static_option('job_hire_modal_title') ?? __('At First Complete Your Payment and Only You Can Place an Order.') }}</h5>
