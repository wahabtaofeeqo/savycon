...
// backend routes
Route::group(['prefix' => 'admin-home/subscription','as'=>'admin.', 'middleware' => ['globalVariable','setlang']], function () {
...
Route::group(['prefix' => 'subscription'],function (){
    ...
    Route::post('/kineticpay-ipn','Frontend\SellerPaymentController@kineticpay_ipn_for_subs' )->name('seller.kineticpay.ipn.subs');
});

Route::group(['prefix' => 'subscription-renew','as'=>'seller.', 'middleware' => 'globalVariable'], function () {
    Route::get('/subscription-success/{id}','Frontend\SellerSubsController@subscription_renew_payment_success')->name('subscription.renew.payment.success');
    Route::get('/subscription-cancel/{id}','Frontend\SellerSubsController@subscription_renew_payment_cancel')->name('subscription.renew.payment.cancel');
    Route::get('/subscription-cancel-static','Frontend\SellerSubsController@subscription_renew_payment_cancel_static')->name('subscription.renew.payment.cancel.static');
});

Route::group(['prefix' => 'subscription-renew'],function (){
    //subscription payment routes
    Route::get('/paypal-ipn','Frontend\SellerRenewPaymentController@paypal_ipn_for_subs')->name('seller.renew.paypal.ipn.subs');
    Route::post('/paytm-ipn','Frontend\SellerRenewPaymentController@paytm_ipn_for_subs')->name('seller.renew.paytm.ipn.subs');
    Route::get('/paystack-ipn','Frontend\SellerRenewPaymentController@paystack_ipn_for_subs')->name('seller.renew.paystack.ipn.subs');
    Route::get('/mollie/ipn','Frontend\SellerRenewPaymentController@mollie_ipn_for_subs')->name('seller.renew.mollie.ipn.subs');
    Route::get('/stripe/ipn','Frontend\SellerRenewPaymentController@stripe_ipn_for_subs')->name('seller.renew.stripe.ipn.subs');
    Route::post('/razorpay-ipn','Frontend\SellerRenewPaymentController@razorpay_ipn_for_subs')->name('seller.renew.razorpay.ipn.subs');
    Route::get('/flutterwave/ipn','Frontend\SellerRenewPaymentController@flutterwave_ipn_for_subs')->name('seller.renew.flutterwave.ipn.subs');
    Route::get('/midtrans-ipn','Frontend\SellerRenewPaymentController@midtrans_ipn_for_subs')->name('seller.renew.midtrans.ipn.subs');
    Route::post('/payfast-ipn','Frontend\SellerRenewPaymentController@payfast_ipn_for_subs')->name('seller.renew.payfast.ipn.subs');
    Route::post('/cashfree-ipn','Frontend\SellerRenewPaymentController@cashfree_ipn_for_subs')->name('seller.renew.cashfree.ipn.subs');
    Route::get('/instamojo-ipn','Frontend\SellerRenewPaymentController@instamojo_ipn_for_subs')->name('seller.renew.instamojo.ipn.subs');
    Route::get('/marcadopago-ipn','Frontend\SellerRenewPaymentController@marcadopago_ipn_for_subs')->name('seller.renew.marcadopago.ipn.subs');
    Route::get('/squareup-ipn','Frontend\SellerRenewPaymentController@squareup_ipn_for_subs' )->name('seller.renew.squareup.ipn.subs');
    Route::post('/cinetpay-ipn', 'Frontend\SellerRenewPaymentController@cinetpay_ipn_for_subs' )->name('seller.renew.cinetpay.ipn.subs');
    Route::post('/paytabs-ipn','Frontend\SellerRenewPaymentController@paytabs_ipn_for_subs' )->name('seller.renew.paytabs.ipn.subs');
    Route::post('/billplz-ipn','Frontend\SellerRenewPaymentController@billplz_ipn_for_subs' )->name('seller.renew.billplz.ipn.subs');
    Route::post('/zitopay-ipn','Frontend\SellerRenewPaymentController@zitopay_ipn_for_subs' )->name('seller.renew.zitopay.ipn.subs');
    Route::post('/kineticpay-ipn','Frontend\SellerRenewPaymentController@kineticpay_ipn_for_subs' )->name('seller.renew.kineticpay.ipn.subs');
});