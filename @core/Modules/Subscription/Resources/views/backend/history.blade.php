                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($data->payment_gateway == 'manual_payment')
                                                @if(!empty($seller_subscription->manual_payment_image))
                                                    <a class="mt-2" href="{{ asset('assets/uploads/subscription/manual-payment/' . $seller_subscription->manual_payment_image) }}" download>
                                                        <i class="las la-download">{{ __('Download Attachment') }}</i>
                                                    </a>
                                                @endif
                                            @endif
                                        </td>
