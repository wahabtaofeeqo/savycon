                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                ...
                                                {{ __('Available Service:') }}  {{$data->service}} <br>
                                                {{ __('Available Job:') }}  {{$data->job}} <br>
                                            @endif

                                            @if($data->payment_status == 'pending' || $data->payment_status == '')
                                                @if($data->type == 'lifetime')
                                                    {{ __('Pending Connect:') }} {{ __('No Limit') }} <br>
                                                    {{ __('Pending Service:') }} {{ __('No Limit') }} <br>
                                                    {{ __('Pending Job:') }} {{ __('No Limit') }} <br>
                                                @else
                                                    {{ __('Pending Connect:') }} {{ $data->initial_connect }} <br>
                                                    {{ __('Pending Service:') }} {{ $data->initial_service }} <br>
                                                    {{ __('Pending Job:') }} {{ $data->initial_job }} <br>
                                                @endif
                                            @endif
                                            <strong class="text-danger">{{ __('Expire Date:') }} {{date('d-m-Y', strtotime($data->expire_date))}}</strong><br>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a class="btn btn-info" href="{{ route('admin.seller.subscription.history',$data->seller_id) }}">{{ __('History') }}</a>
                                        </td>
                                        <td>
                                            @can('send-email')
