...
class PublicChatController extends Controller
{
    ...
    public function buyerConnectedToSeller($id)
    {
        ...
        $sellers = LiveChatMessage::select('id','seller_id')->with('sellerOnlyForAdmin')->get()->unique('seller_id');
    ...
    public function chatDetails(Request $request)
    {
        ...
        $sellers = LiveChatMessage::with('sellerOnlyForAdmin')->get()->unique('seller_id');

        $messages = LiveChatMessage::with('buyerOnlyForAdmin')
            ->where('seller_id', $request->seller_id)
